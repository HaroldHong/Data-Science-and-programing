...
---
这次textMining作业我做的是对450份数据方向工作岗位具体要求的分析展示，想看看当下多数企业的要求有什么相同的地方，为以后的学习找好方向。
```{r }
library(readxl)
library(jiebaRD)
library(jiebaR)
...
```
我前后做了三次清洗，因为本身找的就是数据方向的信息，所以把"数据"列入其中。最后可以得知，我未来几年，至少需要熟练掌握R,python,sql,excel四种大规模要求的工具，最好达到精通的水平。大数的研究在人才需求上小众一点，hive，hadoop,sas没有被提及很多，但最好有了解使用。学历上可以看到门槛是本科，但很看重项目经验，要有建模能力。在学习计算机专业知识之余还应该多了解统计学领域，训练逻辑思维，沟通能力和团队协作能力，对产品和运营不能一问三不知。如此这般，大概5年后我硕士毕业才能找到如意的数据挖掘方向的工作...
